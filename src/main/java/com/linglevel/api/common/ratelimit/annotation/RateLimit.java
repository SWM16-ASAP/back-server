...
/**
 * Rate limiting annotation for API endpoints. When applied to a controller method, it
 * overrides the global rate limit configuration.
 */
...
public @interface RateLimit {
	...
	enum KeyType {
		...
		/**
		 * Automatically determines key type based on authentication: - Authenticated
		 * users: user ID - Unauthenticated users: IP address
		 */
		AUTO,
