...
public class NewsResponse {
    ...
    @Schema(description = "뉴스 ID", example = "60d0fe4f5311236168a109ca")
    private String id;
    
    @Schema(description = "뉴스 제목", example = "Viking King's Bizarre Legacy: The Shocking Truth Behind Your Phone's Most Mysterious Feature!")
