...
public enum ArticleErrorCode {
	...
	CHUNK_NOT_FOUND_IN_ARTICLE(HttpStatus.NOT_FOUND, "Chunk not found in this article."),
	INVALID_SORT_BY(HttpStatus.BAD_REQUEST,
			"Invalid sort_by parameter. Must be one of: view_count, average_rating, created_at."),
