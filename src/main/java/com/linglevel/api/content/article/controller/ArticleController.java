...
public class ArticleController {
	...
	public ResponseEntity<PageResponse<ArticleResponse>> getArticles(
			@ParameterObject @ModelAttribute GetArticlesRequest request, @AuthenticationPrincipal JwtClaims claims) {
	...
	public ResponseEntity<ArticleResponse> getArticle(
			@Parameter(description = "기사 ID", example = "60d0fe4f5311236168a109ca") @PathVariable String articleId,
	...
	public ResponseEntity<PageResponse<ArticleChunkResponse>> getArticleChunks(
		...
		if (claims != null) {
			readingSessionService.startReadingSession(claims.getId(), ContentType.ARTICLE, articleId);
		}
	...
	@PostMapping("/import")
	public ResponseEntity<ArticleImportResponse> importArticle(@RequestBody ArticleImportRequest request) {
