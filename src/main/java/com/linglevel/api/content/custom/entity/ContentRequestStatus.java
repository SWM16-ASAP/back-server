...
public enum ContentRequestStatus {
	...
	PENDING("pending", "대기 중", "AI 처리 대기 중인 상태"), PROCESSING("processing", "처리 중", "AI가 콘텐츠를 처리하고 있는 상태"),
	COMPLETED("completed", "완료", "AI 처리가 성공적으로 완료된 상태"), FAILED("failed", "실패", "AI 처리가 실패한 상태"),
