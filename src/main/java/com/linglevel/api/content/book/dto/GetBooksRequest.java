...
public class GetBooksRequest {
	...
	@Schema(description = "언어 코드 (책 제목 번역)", example = "EN", defaultValue = "EN")
	@Builder.Default
	private LanguageCode languageCode = LanguageCode.EN;

	@Schema(description = "정렬 기준", example = "created_at",
			allowableValues = { "view_count", "average_rating", "created_at" }, defaultValue = "created_at")
	@Builder.Default
	private String sortBy = "created_at";

	@Schema(description = "태그 필터 (쉼표로 구분)", example = "philosophy,children")
	private String tags;

	@Schema(description = "검색 키워드 (제목 또는 작가명)", example = "prince")
