...
public enum DifficultyLevel {
	...
	A0("A0", "Pre-Beginner", "Complete beginner level"), A1("A1", "Beginner", "Basic user level"),
	A2("A2", "Elementary", "Basic user level"), B1("B1", "Intermediate", "Independent user level"),
	B2("B2", "Upper-Intermediate", "Independent user level"), C1("C1", "Advanced", "Proficient user level"),
