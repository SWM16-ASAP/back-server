...
public class WordValidator {
	...
	/**
	 * 문자열 앞뒤의 특수문자를 제거합니다. 유효한 문자(문자 또는 숫자)만 남기고 앞뒤를 trim합니다.
	 */
	...
	/**
	 * 유효한 문자인지 확인합니다. 모든 언어의 문자(한글, 영어, 일본어, 중국어 등)와 숫자를 허용합니다.
	 */
	...
	/**
	 * 단어 내부에 허용되지 않는 문자가 있는지 확인합니다. 띄어쓰기, 엔터, 탭, 특수문자가 포함되어 있으면 true를 반환합니다.
	 */
