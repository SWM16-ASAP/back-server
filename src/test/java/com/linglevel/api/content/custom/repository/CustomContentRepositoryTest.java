...
class CustomContentRepositoryTest extends AbstractDatabaseTest {
	...
	void findCustomContentsByUserWithFilters_shouldReturnContents() {
		...
		// When
		Page<CustomContent> result = customContentRepository.findCustomContentsByUserWithFilters(testUserId, request,
				pageable);
	...
	void findCustomContentsByUserWithFilters_shouldNotReturnOtherUsersContents() {
		...
		// When
		Page<CustomContent> result = customContentRepository.findCustomContentsByUserWithFilters(otherUserId, request,
				pageable);
