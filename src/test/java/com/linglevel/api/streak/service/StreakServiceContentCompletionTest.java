...
class StreakServiceContentCompletionTest {
	...
	void addCompletedContent_MultipleContentsOnSameDay_AllRecorded() {
		...
		// when
		streakService.addCompletedContent(TEST_USER_ID, CONTENT_TYPE, CONTENT_ID_1, true); // 첫
																							// 완료로
																							// 스트릭
																							// 성공
		streakService.addCompletedContent(TEST_USER_ID, CONTENT_TYPE, CONTENT_ID_2, false); // 같은
																							// 날
																							// 추가
																							// 완료
