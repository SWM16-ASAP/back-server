...
class ReadingSessionServiceTest extends AbstractRedisTest {
	...
	void isReadingSessionValid_NoSession() {
		// when
		boolean isValid = readingSessionService.isReadingSessionValid("non-existent-user", ContentType.BOOK,
				TEST_BOOK_ID);
	...
	void isReadingSessionValid_DifferentContentType() {
		...
		// when - ARTICLE로 검증 시도
		boolean isValid = readingSessionService.isReadingSessionValid(TEST_USER_ID, ContentType.ARTICLE, TEST_BOOK_ID);
	...
	void isReadingSessionValid_DifferentContentId() {
		...
		boolean isValid = readingSessionService.isReadingSessionValid(TEST_USER_ID, ContentType.BOOK,
				"different-book-id");
	...
	void startReadingSession_Override() {
		...
		boolean isValidBookA = readingSessionService.isReadingSessionValid(TEST_USER_ID, ContentType.BOOK,
				TEST_BOOK_ID);
