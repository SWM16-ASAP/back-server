...
class StreakServiceRecalculateTest {
	...
	void recalculate_ComplexScenario_CalculatesCorrectly() {
		...
		List<DailyCompletion> completions = List.of(createCompletion(day1, StreakStatus.COMPLETED, 1),
				createCompletion(day2, StreakStatus.COMPLETED, 2), createCompletion(day3, StreakStatus.COMPLETED, 3),
				createCompletion(day4, StreakStatus.FREEZE_USED, 3), createCompletion(day5, StreakStatus.COMPLETED, 4),
				createCompletion(day6, StreakStatus.MISSED, null), createCompletion(day7, StreakStatus.COMPLETED, 1),
