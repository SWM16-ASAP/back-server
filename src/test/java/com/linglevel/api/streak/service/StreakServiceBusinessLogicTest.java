...
class StreakServiceBusinessLogicTest {
	...
	void addCompletedContent_MultipleContents_OnlyFirstIncrementsFirstCount() {
		...
		streakService.addCompletedContent(TEST_USER_ID, CONTENT_TYPE, CHAPTER_ID_1, true); // 스트릭
																							// 완료
		streakService.addCompletedContent(TEST_USER_ID, CONTENT_TYPE, CHAPTER_ID_2, false); // 같은
																							// 날
																							// 추가
																							// 완료
