 ...
 *
 * 주의: - 이 테스트는 실제 AWS Bedrock API를 호출하므로 비용이 발생합니다 - 기본적으로 @Disabled로 비활성화되어 있습니다 - 프롬프트를
 * 수정하거나 결과를 확인할 때만 주석을 제거하여 실행하세요
 *
 * 실행 방법: 1. @Disabled 주석 제거 2. ./gradlew test --tests WordAiServiceIntegrationTest 3. 또는
 * IDE에서 개별 테스트 실행
 */
@SpringBootTest
